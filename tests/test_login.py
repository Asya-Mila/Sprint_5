...
class TestLogin:
    ...
    def test_login_button_main_page(self, driver, accaunt_email, accaunt_password):
    ...
    def test_login_button_personal_acсaunt(self, driver, accaunt_email, accaunt_password):
    ...
    def test_login_registration_form(self, driver, accaunt_email, accaunt_password):
        driver.find_element(*Locators.BUTTON_LOGIN).click()
    ...
    def test_login_password_form_recovery(self, driver, accaunt_email, accaunt_password):
        driver.find_element(*Locators.BUTTON_PERSONAL_ACCOUNT).click()
